...
class MyPdgrAdSyncService
{
    ...
    public function sync(): void
    {
        ...
        foreach ($adUsers as $adUser) {
            ...
            // Prüfen ob Initials gesetzt ist
            if (empty($initials)) {
            ...
            if (!empty($this->changes)) {
                ...
                Logger::db("ad", "info", "Benutzer '{$username}' aktualisiert (MyPdgr-Sync)", [
        ...
        foreach ($this->attributeMap as $adAttr => $MyPdgrField) {
            ...
            if (!empty($MyPdgrValue) && $adValue !== $MyPdgrValue) {
                try {
                    ...
                    Logger::db("ad", "error", "Fehler beim Aktualisieren des Attributs '{$adAttr}' des Benutzers '{$username}'", [
                        "username" => $username,
