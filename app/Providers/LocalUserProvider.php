...
class LocalUserProvider implements UserProvider
{
    ...
    public function validateCredentials(Authenticatable $user, array $credentials)
    {
        ...
        $this->logDb("auth", $ok ? "info" : "warning", $ok ? "Login Benutzer '{$username}' erfolgreich" : "Login Benutzer '{$username}' fehlgeschlagen: Passwort falsch", ["user_id" => $user->id]);

        Logger::debug($ok ? "LocalUserProvider: Authentifizierung für '{$username}' erfolgreich" : "LocalUserProvider: Authentifizierung für '{$username}' fehlgeschlagen");
